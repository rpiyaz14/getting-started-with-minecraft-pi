...
```
The x,y,z variables are the player's position and the block is which block the castle will be made of -this means that later we can make the castle out of any block (even lava!)
